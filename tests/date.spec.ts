...
describe("GetDaysDiff", () => {
	...
	it("should return the days difference with postive value", () => {
		const expected = 1
		const actual = date.getDaysDiff("2019-01-01", "2019-01-02")
		assert.equal(actual, expected)
	});
	...
	it("should return the days difference with negative value", () => {
		const expected = -2
		const actual = date.getDaysDiff("2022-12-06", "2022-12-08", true)
		assert.equal(actual, expected)
	})
});
...
describe("GetTimeDiff", () => {
	...
	it("should return the time difference", () => {
		...
		const actual = date.getTimeDiff("2019-01-01", "2019-01-02", true)
		assert.equal(actual, expected)
	});
